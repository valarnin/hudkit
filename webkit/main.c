...
void int_handler(int s) { handle_gtk_quit(); }
...
int main(int argc, char **argv) {
  ...
  webkit_settings_set_media_playback_allows_inline(wk_settings, true);
  webkit_settings_set_enable_media_stream(wk_settings, true);
  webkit_settings_set_enable_mediasource(wk_settings, true);
  webkit_settings_set_enable_media_capabilities(wk_settings, true);
  ...
  webkit_web_view_run_javascript(
      web_view,
      "window.AudioContext = class extends window.webkitAudioContext { "
      "constructor() { super(); this.resume(); return this; } }",
      NULL, NULL, NULL);
